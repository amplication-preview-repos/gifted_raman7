...
@InputType()
class ConversationCreateNestedManyWithoutPatientsInput {
...
export { ConversationCreateNestedManyWithoutPatientsInput as ConversationCreateNestedManyWithoutPatientsInput };
