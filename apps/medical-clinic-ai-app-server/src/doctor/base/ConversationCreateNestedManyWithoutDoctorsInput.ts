...
@InputType()
class ConversationCreateNestedManyWithoutDoctorsInput {
...
export { ConversationCreateNestedManyWithoutDoctorsInput as ConversationCreateNestedManyWithoutDoctorsInput };
